...
<div class="slideFit"><img class="mySlides slideFit" src="img/slideshow.jpg">
</div>
<div class="slideFit"><img class="mySlides slideFit" src="img/slideshow2.jpg"> 
</div>
<div class="slideFit"><img class="mySlides slideFit" src="img/slideshow3.jpg"> 
</div>
<img class="mySlides" src="img/slideshow.jpg">
		<img class="mySlides" src="img/slideshow2.jpg"> 
		<img class="mySlides" src="img/slideshow3.jpg"> 
